...
class __TwigTemplate_a41207d3026441a346ca2fc861ed78c5fe99237bf717007a7a3f0e4a8c8e4c81 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        ((twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 20, $this->source); })()), "publishDate", [], "any", false, false, false, 20)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 20, $this->source); })()), "publishDate", [], "any", false, false, false, 20), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>Publish_date</th>
                <td>{{ comment.publishDate ? comment.publishDate|date('Y-m-d H:i:s') : '' }}</td>
            </tr>
        </tbody>
    </table>
{% endblock %}
", "comment/show.html.twig", "/Users/loryleticee/Desktop/projet/ipssi-sf-tp/templates/comment/show.html.twig");
    }
}
