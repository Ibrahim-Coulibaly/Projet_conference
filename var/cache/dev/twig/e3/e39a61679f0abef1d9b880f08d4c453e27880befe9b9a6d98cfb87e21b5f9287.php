...
class __TwigTemplate_6163a79c49bbc51fee161147146b79b4495a9f76aa832ecafe01713bb13cbbf3 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"example-wrapper\">
    ...
    ";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["games"]) || array_key_exists("games", $context) ? $context["games"] : (function () { throw new RuntimeError('Variable "games" does not exist.', 15, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["game"]) {
            // line 16
            echo "        <ul>
            <li><div ><label>";
            // line 17
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["game"], "id", [], "any", false, false, false, 17), "html", null, true);
            echo "</label> : <br>  </div></li>
        </ul>
        </div>
    ";
        }
    ...
    {
        return array (  109 => 17,  106 => 16,  102 => 15,  96 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<div class=\"example-wrapper\">
    ...
    {% for game in games %}
        <ul>
            <li><div ><label>{{ game.id }}</label> : <br>  </div></li>
        </ul>
        </div>
    {% endfor %}
{% endblock %}
", "account/index.html.twig", "/Users/loryleticee/Desktop/projet/ipssi-sf-tp/templates/account/index.html.twig");
    }
}
